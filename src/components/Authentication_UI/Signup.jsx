...
export default function CreateTodo(){
    ...
    return <div>
       ...
       <button className="btn" onClick={async ()=>{
            console.log("hello")
            await fetch("http://localhost:3000/signup",     /*The fetch function takes an options object as its second parameter. Here, the options object specifies the method as "POST" and includes the request body.
