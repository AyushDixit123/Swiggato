...
export default function CreateTodo(){
    ...
    return <div>
       ...
       <button className="btn" onClick={async ()=>{
            console.log("hello")
            await fetch("https://swiggato-backend-ny4ekiku6-ayushs-projects-e3d529a3.vercel.app/signup",     /*The fetch function takes an options object as its second parameter. Here, the options object specifies the method as "POST" and includes the request body.
