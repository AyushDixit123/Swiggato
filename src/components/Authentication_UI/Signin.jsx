        ...
        <div className="signup_container">
            ...
            <div className="sign-right">
                ...
                <button className="btn" onClick={async () => {
                    console.log("hello")
                    await fetch("ttps://swiggato-backend-zziz.onrender.com/signin",     /*The fetch function takes an options object as its second parameter. Here, the options object specifies the method as "POST" and includes the request body.
