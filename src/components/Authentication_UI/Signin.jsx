...
export default function Signin(){
    ...
    return <div>
        ...
        <button className="btn" onClick={async ()=>{
            console.log("hello")
            await fetch("https://swiggato-backend-hi0rsdaeu-ayushs-projects-e3d529a3.vercel.app/signin",     /*The fetch function takes an options object as its second parameter. Here, the options object specifies the method as "POST" and includes the request body.
